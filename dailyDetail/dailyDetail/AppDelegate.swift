...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        // 注册
        AnalyticsManager.shared.register(strategy: SensorsAnalyticsStrategy())
        AnalyticsManager.shared.register(strategy: AppsFlyerAnalyticsStrategy())
        AnalyticsManager.shared.register(strategy: ZhugeAnalyticsStrategy(), enabled: false)
        // 公共属性
